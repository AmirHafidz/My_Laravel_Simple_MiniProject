...
<script>
    ...
    function tekan(){
        document.getelementbyclassname("links").style.display = "block";
    }
</script>

<link href="bootstrap/css/bootstrap.min.css" rel="stylesheet">

<link href="bootstrap/headers.css" rel="stylesheet">
<link href="bootstrap/headers1.css" rel="stylesheet">

<link href="bootstrap/footers.css" rel="stylesheet">
...
<script src="url('bootstrap/dashboard.js')"></script>
      ...
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          <a href="#" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
            ...
            <img src="bootstrap/logowolf.png" class="bi me-2" width="50" height="50">
          </a>
          ...
          <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            ...
            <li>
                <button type="button" onclick="tekan()" class="click">
                <a class="nav-link text-white" onclick="tekan()">
                <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#people-circle"/></svg>
                {{ session()->get('user')->name}}
                
                <!-- <div class="list">

                    <button class="links" onclick="window.location.href='/logout'">Log Out</button> -->
...
<!-- <div class="px-3 py-2 border-bottom mb-3" >
  ...
  <!-- <div class="text-end">
        ...
        <button type="button" class="btn btn-primary" onclick="window.location.href='/masuk'">Sign In</button>
  </div>
  </div>
</div> -->
